(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-flipt"] = factory(require("axios"));
	else
		root["vue-flipt"] = factory(root["axios"]);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "a", function() { return /* binding */ dollar_flipt_DollarFlipt; });
...
function hash(_ref) {
  var entityId = _ref.entityId,
      flagKey = _ref.flagKey,
      _ref$context = _ref.context,
      unsortedContext = _ref$context === void 0 ? {} : _ref$context;
  var contextKeys = Object.keys(unsortedContext);
  contextKeys.sort();
  var context = contextKeys.reduce(function (acc, key) {
...
var FIFTEEN_MINUTES_IN_MILLIS = 15 * 60 * 1000;
var defaultCacheGracePeriod = FIFTEEN_MINUTES_IN_MILLIS;
var cache_Cache = /*#__PURE__*/function () {
  function Cache() {
    var cacheGracePeriod = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultCacheGracePeriod;
  ...
  _createClass(Cache, [{
    ...
    key: "addToCache",
    value: function addToCache(request) {
      var flagKey = request.flagKey,
          entityId = request.entityId,
          context = request.requestContext,
          timestampString = request.timestamp;

      var hashedKey = this._getKey({
        flagKey: flagKey,
        entityId: entityId,
        context: context
      });

      var timestamp = new Date(timestampString).valueOf();

      this._map.set(hashedKey, {
        request: request,
        timestamp: timestamp
      });
    }
    ...
    key: "getCached",
    value: function getCached(_ref2) {
      var flagKey = _ref2.flagKey,
      ...
      var cachedValue = this._map.get(hashedKey);
...
// CONCATENATED MODULE: ./src/dollar-flipt.js
...
function dollar_flipt_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function dollar_flipt_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function dollar_flipt_createClass(Constructor, protoProps, staticProps) { if (protoProps) dollar_flipt_defineProperties(Constructor.prototype, protoProps); if (staticProps) dollar_flipt_defineProperties(Constructor, staticProps); return Constructor; }
...
//# sourceMappingURL=vue-flipt.umd.js.map